/**
 * Simplified MOA test script
 * Tests whether MOA responses are being properly generated and stored
 */
...
/**
 * Tests MOA responses by querying the database
 */
  ...
  try {
    ...
    for (const row of moaResponses.rows) {
      ...
      responseResults.push({
        id,
        allPassed,
        tests: tests.map(t => ({ name: t.name, passed: t.passed }))
      });
    }
...
/**
 * Generates a test MOA response by calling the API
 */
